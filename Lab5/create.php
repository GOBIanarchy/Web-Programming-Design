...
<head>
    <meta charset="UTF-8">
    <title>ВЕБ ЛАБ 5</title>
    <link rel="stylesheet" href="styles/style.css?v=1">
</head>
<body>

<header>
    <div class="header_text"><a class="links" href="/menu.php?id=0">Каталог</a></div>
...
<div class="buket">
    <div class="buket_text">
        ...
        <div class="buket_button">
            <a class="links" href="/menu.php?id=0">Смотреть каталог</a>
        </div>
    </div>
...
<div class="sale_container">
    <div class="sale_container_text">
        ...
        <h2>Если заказываете у нас букет впервые - при оформлении заказа введите промокод "Botanika2022" и получите скидку 30%</h2>
    </div>
...
<footer>
    <div class="footer_text"><a class="links" href="/menu.php?id=0">Каталог</a></div>
